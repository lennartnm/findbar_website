...
export default function Page() {
  ...
  return (
    <article className="prose prose-zinc mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      ...
      {/* Bild 1 – Vorlage */} <figure className="mt-8 overflow-hidden rounded-2xl border border-zinc-200"> <div className="relative w-full" style={{ aspectRatio: "16 / 6" }}> <picture> <source media="(max-width: 640px)" srcSet="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?q=80&w=1200&auto=format&fit=crop" /> <img loading="lazy" src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1600&auto=format&fit=crop" alt="Serverracks On-Premise – Symbol für eigene Infrastruktur" className="absolute inset-0 h-full w-full object-cover" /> </picture> </div> <figcaption className="text-sm text-zinc-600"> On-Premise bietet maximale Kontrolle – aber auch volle Betriebspflicht. </figcaption> </figure> </section>
