...
export default function Article() {
  ...
  const title =
    "Suez vs. Kap 2025: Laufzeiten & Kosten China → Europa für E-Commerce";
  const description =
      ...
      <article lang="de" className="relative mx-auto max-w-3xl px-4 py-10">
        ...
        <aside className="mb-10 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
          ...
          <ul className="space-y-3">
            <TLDRItem>
              <strong>Transitzeit:</strong> Suez bleibt am schnellsten (z. B. Shanghai→Rotterdam ~42 Tage), Kap-Umfahrung +8–12 Tage je nach Loop.{" "}
              {/* :contentReference[oaicite:0]{index=0} */}
            </TLDRItem>
            <TLDRItem>
              <strong>Kosten:</strong> Mitte Aug 2025 WCI ~2.350 USD/FEU; im Juli FBX11 ~3.384 USD/FEU. PSS (z. B. 250 USD/TEU) kann Q3/Q4 zusätzlich greifen.{" "}
              {/* :contentReference[oaicite:1]{index=1} */}
            </TLDRItem>
            <TLDRItem>
              <strong>Zuverlässigkeit:</strong> Schedule Reliability erholte sich auf ~66 % im Mai 2025; Kap-Netze bleiben bei einigen Carriern Standard.{" "}
              {/* :contentReference[oaicite:2]{index=2} */}
            </TLDRItem>
            <TLDRItem>
              <strong>Häfen:</strong> Ob Rotterdam oder Hamburg schneller ist, hängt vom Loop ab (First-Port-of-Call variiert). Rotterdam verzeichnet zahlreiche Erstläufe.{" "}
              {/* :contentReference[oaicite:3]{index=3} */}
            </TLDRItem>
            <TLDRItem>
              <strong>Compliance:</strong> Seit 1.4.2025 gilt EU-ICS2 Haus-Level-ENS für Seefracht – rechtzeitig Daten einspielen.{" "}
        ...
        <section className="prose prose-zinc max-w-none">
          ...
          <p>
            ...
            ein stabiles Ost-West-Netz <em>via Kap</em> bestätigt – Planbarkeit geht vor, selbst wenn die Etmale länger sind.{" "}
        ...
        <section className="prose prose-zinc max-w-none mt-12">
          ...
          <ul>
            <li>
              <strong>Spotraten:</strong> Der Drewry World Container Index lag am 14. Aug 2025 bei ca. <strong>2.350 USD/FEU</strong>. Der FBX11 (China→Nordeuropa) meldete Anfang Juli ~<strong>3.384 USD/FEU</strong>.{" "}
              {/* :contentReference[oaicite:6]{index=6} */}
            </li>
            <li>
              <strong>Zuverlässigkeit:</strong> Sea-Intelligence zeigt für Mai 2025 eine globale Schedule Reliability von <strong>65,8 %</strong> (höchster Wert seit 11/2023).{" "}
              {/* :contentReference[oaicite:7]{index=7} */}
            </li>
            <li>
              <strong>Peak-Season-Surcharges (PSS):</strong> 2025 wurden auf Asien→Nordeuropa wieder PSS publiziert, z. B. <strong>250 USD/TEU</strong> (CMA CGM ab 16. Jun 2025).{" "}
              {/* :contentReference[oaicite:8]{index=8} */}
            </li>
            <li>
              <strong>Kap-Detour:</strong> Reedereiadvisories nennen weiterhin Umroutungen via Kap; die Umfahrung erhöht die Transitzeit typischerweise um ~<strong>8–14 Tage</strong> vs. Suez (service-abhängig).{" "}
              {/* :contentReference[oaicite:9]{index=9} */}
            </li>
            <li>
              <strong>Nordrange-Staus:</strong> In H1/2025 wurde wiederholt über anhaltende Nordsee-Hafenstaus berichtet (z. B. Ankerlieger vor Rotterdam).{" "}
        ...
        <section className="prose prose-zinc max-w-none mt-12">
          ...
          <p>
            ...
            Rechne zusätzlich mit PSS (z. B. <strong>250 USD/TEU</strong> lt. CMA CGM), BAF/FAF und Lokalkosten.{" "}
          ...
          <p>
            ...
            Der Break-even zu FCL liegt häufig bei <strong>~12–18 m³</strong> – in der „Grauzone“ (10–15 m³) immer beide Angebote vergleichen.{" "}
          ...
          <p>
            ...
            (z. B. CMA CGM: <strong>250 USD/TEU</strong> ab 16. Jun 2025; Maersk Updates im Juli/August). Prüfe <em>je Buchung</em> die Carrier-Ankündigung.{" "}
        ...
        <section className="prose prose-zinc max-w-none mt-12">
          ...
          <p>
            ...
            Der Hafen Rotterdam weist jedoch regelmäßig zahlreiche <em>First-Port-of-Call</em>-Anläufe aus, was Importen häufig einen früheren Entlade-Slot verschafft.{" "}
          ...
          <div className="rounded-2xl border border-zinc-200 p-5">
            <ul className="space-y-2">
              ...
              <CheckLi>
                ...
                innerhalb 24–48 h vor ETA, je nach Hafen.{" "}
              ...
              <CheckLi>
                ...
                Ab 1.9.2025 wird ICS2 vollumfänglich scharfgeschaltet. Klärt, wer filed (Carrier vs. Spediteur).{" "}
              ...
              <CheckLi>
                <strong>Detention/Demurrage</strong> vermeiden: Termine für Abholung/De-vanning/Leercontainer-Rückgabe planen (Definitionen siehe Glossar).{" "}
        ...
        <section className="prose prose-zinc max-w-none mt-12">
          ...
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
            ...
            <ul className="space-y-2">
              ...
              <CheckLi>
                <Pill>Preisrisiko</Pill>Spot vs. Kontrakt: Für Q4 Peaks PSS/FAK/GRIs einpreisen; zeitnah quoten lassen (FBX/WCI beobachten).{" "}
        ...
        <section className="prose prose-zinc max-w-none mt-12">
          ...
          <details className="group rounded-2xl border border-zinc-200 p-4 mt-3">
            ...
            <div className="mt-2 text-zinc-700">
              ...
              Indizes wie WCI/FBX geben wöchentlich Orientierung.{" "}
          ...
          <details className="group rounded-2xl border border-zinc-200 p-4 mt-3">
            ...
            <div className="mt-2 text-zinc-700">
              ...
              Details und Fristen je Carrier/Hafen.{" "}
          ...
          <details className="group rounded-2xl border border-zinc-200 p-4 mt-3">
            ...
            <div className="mt-2 text-zinc-700">
              40HC bietet ~<strong>76 m³</strong> Volumen (mehr Höhe) und ist für voluminöse, leichte Güter beliebt. Für kompaktere, schwere Waren kann 20′ sinnvoll sein.{" "}
