...
const sections = [
  ...
  },
  {
    ...
    content:
      "Der PV-Markt wächst rasant; in Deutschland wurden 2024 laut Branchenreports rund 16,9 GWp neu installiert. Die LCOE von PV liegen hierzulande typischerweise im einstelligen bis niedrigen zweistelligen Cent-Bereich pro kWh – oft unter typischen Gewerbestrompreisen. Batteriespeicher sind 2024/25 deutlich günstiger geworden; sinkende Batteriekosten stärken Peak-Shaving- und Eigenverbrauchs-Use-Cases. Gleichzeitig gelten für neue Anlagen Einspeisevergütungen (EEG), die vierteljährlich angepasst werden und die Wirtschaftlichkeit von Überschusseinspeisung verbessern.",
  },
  {
    id: "business-case",
  ...
  },
  {
    ...
    content:
      "EEG-Einspeisevergütungen sichern Erlöse für Überschuss- oder Volleinspeisung über 20 Jahre; die konkreten Sätze variieren. Auf Bundesebene sind PV und Speicher 2025 v. a. über zinsgünstige Kredite (KfW 270/„Erneuerbare Energien – Standard“) finanzierbar. Für größere Verbraucher beeinflussen Netzentgelte (Arbeitspreis + ggf. Leistungspreis) sowie Umlagen den Business Case – Peak Shaving kann hier spürbar entlasten.",
  },
  {
    id: "fehler",
...
const BusinessCaseChart = () => {
  const items = [
    { k: "Netzstrom (KMU neu, 2025)", v: 18.0 },
    { k: "PV LCOE (Spanne, Mitte)", v: 8.0 },
    { k: "EEG Teileinspeisung", v: 7.86 },
  ...
  return (
    <figure className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
      ...
      <figcaption className="mt-2 text-sm text-zinc-600">
        ...
        variieren je nach Standort, Größe &amp; Tarif.
      </figcaption>
    </figure>
  );
};
      ...
      >
        ...
        <aside className="mb-10 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
          ...
          <ul className="space-y-3">
            ...
            <TLDRItem icon={ShieldCheck}>
              ...
              ~18&nbsp;ct/kWh; Peak Shaving kann zusätzlich entlasten.
            </TLDRItem>
            <TLDRItem icon={PiggyBank}>
              <strong>Einspeisung:</strong> Neue Anlagen erhalten je nach Modell feste
              Einspeisevergütungen (Teile-/Volleinspeisung).
            </TLDRItem>
            <TLDRItem icon={Battery}>
              <strong>Kosten sinken:</strong> Fallende Batteriepreise machen Speicher-Anwendungen
              zunehmend wirtschaftlich.
            </TLDRItem>
            <TLDRItem icon={Sun}>
              <strong>Markt:</strong> Deutschland verzeichnet starkes PV-Wachstum – du planst nicht
              im Nischenmarkt, sondern im Mainstream.
            </TLDRItem>
          </ul>
        </aside>
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-10">
            ...
            <div className="rounded-2xl border border-zinc-200 p-5">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <CheckLi>Peak Shaving reduziert teure Lastspitzen (RLM-Tarife/Leistungspreise).</CheckLi>
          ...
          <p className="mb-5 leading-relaxed">
            ...
            bleibt PV bis 2030 das Zugpferd der EE-Kapazitäten. Die LCOE für PV in Deutschland
            liegen je nach System und Standort im Bereich weniger bis rund einem Dutzend Cent pro
            kWh, meist unter Beschaffungs- und Netzkosten des Netzstroms.
          </p>
          ...
          <figure className="mt-6 rounded-2xl border-l-4 border-emerald-600 bg-emerald-50 p-5">
            ...
            <figcaption className="mt-2 text-sm text-zinc-600">
              — Redaktionelle Einschätzung basierend auf aktuellen Marktberichten.
            </figcaption>
          </figure>
          ...
          <div className="rounded-2xl border border-zinc-200 p-5 bg-white mb-6">
            ...
            <p className="text-sm text-zinc-700 mb-3">
              Standort mit 500&nbsp;MWh/a Verbrauch (RLM), Arbeitspreis 18&nbsp;ct/kWh,
              Leistungspreise relevant. PV-Dachanlage 300&nbsp;kWp (~290&nbsp;MWh/a), CAPEX
              900&nbsp;€/kWp, Speicher 300&nbsp;kWh CAPEX 400&nbsp;€/kWh.
            </p>
            <ul className="text-sm space-y-2">
              <CheckLi>Wert Eigenverbrauch: 290&nbsp;MWh × 0,18&nbsp;€/kWh = 52.200&nbsp;€/a.</CheckLi>
              <CheckLi>
                Peak-Shaving-Effekt (konservativ): 10&nbsp;% geringere Jahreshöchstlast → mögliche
                Netzentgelt-Ersparnis (standortabhängig) – hier qualitativ bewertet.
              </CheckLi>
              <CheckLi>
                Einspeiseerlöse für Überschuss: konservativ mit aktuellen Vergütungssätzen rechnen.
              </CheckLi>
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-zinc-200 p-5">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <CheckLi>RLM-Tarif mit Leistungspreisen → Peak Shaving spart Netzentgelte.</CheckLi>
                <CheckLi>
                  EV-Laden, Kälte/Prozesswärme → flexible Verbraucher zum „Füllen“ von PV-Spitzen.
                </CheckLi>
              </ul>
            </div>
            <div className="rounded-2xl border border-zinc-200 p-5">
              ...
              <ul className="space-y-2 text-sm">
                <CheckLi>
                  Gute Tageslast &amp; kaum Lastspitzen → Speicher bringt wenig Zusatznutzen.
                </CheckLi>
          ...
          <div className="mt-8 overflow-x-auto">
            <table
              ...
              aria-describedby="kopplung-caption"
            >
          ...
          <figure className="mt-8 overflow-hidden rounded-2xl border border-zinc-200">
            ...
            <figcaption className="text-sm text-zinc-600">
              Dachfläche prüfen: Statik, Fluchtwege, Verschattung – und{" "}
              <em>Brandschutz-/Abschaltkonzepte</em> früh einplanen.
            </figcaption>
          </figure>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-zinc-200 p-5 bg-white">
              ...
              <ul className="text-sm space-y-2">
                ...
                <CheckLi>Peak Shaving mit 15-min-Fenstern (RLM) und dynamischen Limits.</CheckLi>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-zinc-200 p-5 bg-white">
              ...
              <ul className="text-sm space-y-2">
                <li>
                  <Pill>EEG</Pill> Neue Einspeisesätze gelten 20 Jahre ab Inbetriebnahme; prüfe die
                  aktuell gültigen Werte (Teil-/Volleinspeisung).
                </li>
                <li>
                ...
                <li>
                  <Pill>Netzentgelte</Pill> Aufschläge/Leistungspreise im Blick behalten – Peak
                  Shaving kann Leistungskosten senken.
                </li>
              </ul>
            </div>
          ...
          <figure className="mt-8 overflow-hidden rounded-2xl border border-zinc-200">
            <div className="relative w-full" style={{ aspectRatio: "16 / 6" }}>
              <picture>
                <source
                  media="(max-width: 640px)"
                  srcSet="https://source.unsplash.com/1600x600/?battery,energy,container"
                />
                <img
                  loading="lazy"
        ...
        <section id="zusammenfassung" className="mt-14">
          ...
          <p className="leading-relaxed">
            ...
            entsteht ein belastbarer Business Case – förderfähig finanziert und über 20 Jahre
            planbar. Wer jetzt strukturiert plant, senkt Kosten, CO₂ und Risiken zugleich.
          </p>
        </section>
        ...
        <section className="mt-14">
          ...
          <ul className="list-disc ml-5 space-y-2 text-sm">
            <li>Fraunhofer ISE: LCOE-Studien &amp; Photovoltaics Report.</li>
            <li>IEA / IEA-PVPS: Renewables &amp; Trends in PV Applications.</li>
            <li>BDEW: Strompreis- und Netzentgelt-Analysen für Unternehmen.</li>
            <li>BloombergNEF: Battery Pack Prices – jährliche Marktanalyse.</li>
            <li>KfW: Programm „Erneuerbare Energien – Standard (270)“.</li>
            <li>Fachartikel: Peak Shaving &amp; RLM-Tarife in der Praxis.</li>
          </ul>
        </section>
