...
const Anchor = ({ id }: { id: string }) => <div id={id} aria-hidden className="pt-24 -mt-24" />; // stable anchor
    ...
    <section>
        ...
        <div className="rounded-2xl border border-zinc-200 p-5">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <CheckLi>
              ...
              <span className="sr-only">:contentReference[oaicite:3]{index=3}</span>
            </CheckLi>
            <CheckLi>
              PV-Ausbau & Erneuerbare drücken Großhandelspreise – laut Jahresauswertung 2024.{" "}
              <span className="sr-only">:contentReference[oaicite:4]{index=4}</span>
            </CheckLi>
          </ul>
        </div>
      </div>
        ...
        <div className="rounded-2xl border border-zinc-200 p-5 bg-white">
          ...
          <ul className="text-sm space-y-2">
            <li>
              ...
              <span className="sr-only">:contentReference[oaicite:5]{index=5}</span>
            </li>
            <li>
              <Pill>Schneller</Pill> Solarpaket I beschleunigt Prozesse und hebt für &gt;40-kW-Dächer die Förderung an.
              <span className="sr-only">:contentReference[oaicite:6]{index=6}</span>
            </li>
            <li>
              <Pill>Ausschreibungen</Pill> Größere Anlagen: Höchstwert 2025 im ersten Segment 6,80 ct/kWh.
              <span className="sr-only">:contentReference[oaicite:7]{index=7}</span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-200 p-5 bg-zinc-50">
          ...
          <ul className="text-sm space-y-2">
            <li>
              ...
              <span className="sr-only">:contentReference[oaicite:8]{index=8}</span>
            </li>
            <li>
              <Pill>AfA</Pill> Übliche Nutzungsdauer PV 20 Jahre (lineare Abschreibung).
              <span className="sr-only">:contentReference[oaicite:9]{index=9}</span>
            </li>
            <li>
              <Pill>§7g EStG</Pill> Sonder-AfA/Investitionsabzugsbetrag für KMU nach Voraussetzungen (Einzelfall!).
              <span className="sr-only">:contentReference[oaicite:10]{index=10}</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-zinc-200 p-5 bg-white">
          ...
          <ul className="text-sm space-y-2">
            <li>
              ...
              <span className="sr-only">:contentReference[oaicite:11]{index=11}</span>
            </li>
            <li>
              <Pill>4110</Pill> Mittelspannung ab 135 kW inkl. Zertifikate/Protokolle (Anhang E).
              <span className="sr-only">:contentReference[oaicite:12]{index=12}</span>
            </li>
            <li>
              <Pill>TAB 2023</Pill> Netzbetreiber-TAB präzisieren Messkonzepte & Kuppelschalter; 4110-Pflicht ≥ 135 kW.
              <span className="sr-only">:contentReference[oaicite:13]{index=13}</span>
            </li>
            <li>
              <Pill>Speicher</Pill> FNN-Hinweise für Anschluss & Betrieb von Speichern (NS/MS).
              <span className="sr-only">:contentReference[oaicite:14]{index=14}</span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-200 p-5 bg-zinc-50">
          ...
          <p className="mt-2 text-xs text-zinc-600">
            ...
            <span className="sr-only">:contentReference[oaicite:15]{index=15}</span>
          </p>
        </div>
      </div>
      ...
      <ol className="list-decimal ml-5 space-y-3 leading-relaxed">
        ...
        <li>
          ...
          <span className="sr-only">:contentReference[oaicite:16]{index=16}</span>
        </li>
        <li>
          <strong>Recht & Netz sichern:</strong> EEG-Zuordnung (Teil-/Volleinspeisung), Direktvermarktung, Messkonzept, Netzanschluss,
          VDE-Nachweise.
          <span className="sr-only">:contentReference[oaicite:17]{index=17}</span>
        </li>
        <li>
        ...
        <li>
          ...
          <span className="sr-only">:contentReference[oaicite:18]{index=18}</span>
        </li>
      </ol>
