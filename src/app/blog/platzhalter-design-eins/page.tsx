...
import { CheckCircle2, ShieldCheck, Gauge, PiggyBank, Server, Cloud, Network, FileSearch, Landmark, BadgeEuro, ArrowRight, Info, CalendarClock, Timer, } from "lucide-react";
...
const sections = [
  ...
  },
  {
    id: "fehler",
    title:
      "Platzhalter: Typische Fehler & Risiken – und wie du sie vermeidest",
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer facilisis, risus in tincidunt imperdiet, felis magna gravida ipsum, a laoreet eros nisi a nibh. Proin aliquet dictum lorem, non faucibus mauris luctus in. Vivamus suscipit viverra elit, id volutpat justo malesuada at. Suspendisse potenti. Etiam congue, est in porttitor egestas, libero risus iaculis orci, eu fermentum eros augue ac nunc. Phasellus ac cursus dui. Mauris vitae leo turpis. Nullam volutpat enim et mauris tempus, nec dictum nisl porta. Ut auctor erat sed orci scelerisque, nec dignissim justo viverra. Sed eget felis ac magna posuere pretium non id ipsum. Donec cursus faucibus varius.",
  },
];
  ...
  return (
    <figure className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
      ...
      <figcaption className="mt-2 text-sm text-zinc-600">
        Platzhalter für die Bildunterschrift des Diagramms
      </figcaption>
    </figure>
  );
};
      ...
      >
            ...
            <div className="relative w-full" style={{ aspectRatio: "16 / 6" }}>
              <picture>
                ...
                <img
                  ...
                  alt="Beschreibung des Bildes aus der Hero Section"
        ...
        <aside className="mb-10 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
          ...
          <ul className="space-y-3">
            <TLDRItem icon={ShieldCheck}>
              Platzhalter für TL;DR Punkt 1, <strong>wichtiges</strong> betonen.
            </TLDRItem>
            <TLDRItem icon={Gauge}>
              Platzhalter für TL;DR Punkt 2, <strong>wichtiges</strong> betonen.
            </TLDRItem>
            <TLDRItem icon={PiggyBank}>
              Platzhalter für TL;DR Punkt 3, <strong>wichtiges</strong> betonen.
            </TLDRItem>
            <TLDRItem icon={Network}>
              Platzhalter für TL;DR Punkt 4, <strong>wichtiges</strong> betonen.
            </TLDRItem>
            <TLDRItem icon={FileSearch}>
              Platzhalter für TL;DR Punkt 5, <strong>wichtiges</strong> betonen.
            </TLDRItem>
          </ul>
        </aside>
        ...
        >
          ...
          <ol className="list-decimal ml-5 space-y-2">
            ...
            <li>
              <a className={hover:underline ${accent} font-medium} href="#abschnitt-3">
                Abschnitt 3
              </a>
            </li>
            <li>
              <a className={hover:underline ${accent} font-medium} href="#abschnitt-4">
                Abschnitt 4
              </a>
            </li>
            <li>
              <a className={hover:underline ${accent} font-medium} href="#abschnitt-5">
                Abschnitt 5
              </a>
            </li>
            <li>
        ...
        <section>
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-zinc-200 p-5">
              <h3 className="font-semibold mb-2 flex items-center gap-2">
                <ShieldCheck className={w-5 h-5 ${accent}} /> Erneuter Vergleich zwei fachlich
                identifizierten Möglichkeiten
              </h3>
              <ul className="space-y-2 text-sm">
            ...
            <div className="rounded-2xl border border-zinc-200 p-5">
              <h3 className="font-semibold mb-2 flex items-center gap-2">
                <BadgeEuro className={w-5 h-5 ${accent}} /> Erneuter Vergleich zwei fachlich
                identifizierten Möglichkeiten
              </h3>
              <ul className="space-y-2 text-sm">
                <CheckLi>Stichpunkt 1</CheckLi>
          ...
          <aside className="mt-10 rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
            ...
            <ul className="list-disc ml-5 text-sm space-y-2">
              <li>
                <a className={hover:underline ${accent}} href="/platzhalter_weiterfuehrender_artikel_1">
                  Platzhalter für Artikel 1
                </a>
              </li>
              <li>
                <a className={hover:underline ${accent}} href="/platzhalter_weiterfuehrender_artikel_2">
                  Platzhalter für Artikel 2
                </a>
              </li>
              <li>
                <a className={hover:underline ${accent}} href="/platzhalter_weiterfuehrender_artikel_3">
                  Platzhalter für Artikel 3
                </a>
              </li>
              <li>
                <a className={hover:underline ${accent}} href="/platzhalter_weiterfuehrender_artikel_4">
                ...
                mainEntity: [
                  {
                    ...
                    acceptedAnswer: { "@type": "Answer", text: "Platzhalter für Antwort 1" },
                  },
                  {
                    "@type": "Question",
                    name: "Platzhalter für Frage 2",
                    acceptedAnswer: { "@type": "Answer", text: "Platzhalter für Antwort 2" },
                  },
                  {
                    "@type": "Question",
                    name: "Platzhalter für Frage 3",
                    acceptedAnswer: { "@type": "Answer", text: "Platzhalter für Antwort 3" },
                  },
                  {
                    "@type": "Question",
                    name: "Platzhalter für Frage 4",
                    acceptedAnswer: { "@type": "Answer", text: "Platzhalter für Antwort 4" },
                  },
                ],
              }),
            }}
        ...
        <section aria-label="Kontakt" className="mt-14">
          <div className="rounded-2xl border-2 border-dashed border-emerald-300 p-6 text-center">
            <h2 className="text-xl font-bold mb-2">
              Platzhalter für offene CTA relevante Frage
            </h2>
