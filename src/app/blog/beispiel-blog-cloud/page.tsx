...
import { CheckCircle2, ShieldCheck, Gauge, PiggyBank, Server, Cloud, Network, FileSearch, Landmark, BadgeEuro, ArrowRight, Info } from "lucide-react";
...
const Anchor = ({ id }: { id: string }) => <div id={id} aria-hidden className="pt-24 -mt-24" />; // stable anc
        ...
        <section className="mt-14 mb-20">
          ...
          <dl className="grid sm:grid-cols-2 gap-4 text-sm">
            <div className="rounded-xl border border-zinc-200 p-4">
              <dt className="font-semibold">CapEx</dt>
              <dd>Investive Ausgaben (z. B. Server-Hardware, RZ-Ausstattung), die über Jahre abgeschrieben werden.</dd>
            </div>
            <div className="rounded-xl border border-zinc-200 p-4">
              <dt className="font-semibold">OpEx</dt>
              <dd>Laufende Betriebs-Ausgaben (z. B. Instanz-/Lizenz-/Energie-/Personal-Kosten) – typisch für Cloud.</dd>
            </div>
            <div className="rounded-xl border border-zinc-200 p-4">
              <dt className="font-semibold">PUE</dt>
              <dd>Power Usage Effectiveness; Verhältnis Gesamtstrom / IT-Strom. Je näher 1, desto effizienter die Facility.</dd>
            </div>
            <div className="rounded-xl border border-zinc-200 p-4">
              <dt className="font-semibold">Latenz</dt>
              <dd>Verzögerung in ms bei Datenübertragung. Kritisch für Echtzeit-/Edge-Anwendungen.</dd>
            </div>
            <div className="rounded-xl border border-zinc-200 p-4">
              <dt className="font-semibold">Daten-Souveränität</dt>
              <dd>Fähigkeit, Hoheit über Datenzugriffe, -speicherung und -verarbeitung rechtskonform sicherzustellen.</dd>
            </div>
          </dl>
        </section>
      </article>
