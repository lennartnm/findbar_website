...
export default function Page() {
  ...
  return (
    <>
      ...
      />
      {/* Reading time enhancer */}
      <Script id="reading-time" strategy="afterInteractive">
        {`
          (function(){
        ...
        <header className="hero">
          <div className="container">
            ...
            <p className="subhead">
              ...
              fundiert zu entscheiden – inklusive Praxisbeispiele und
              Checkliste.
            </p>
        ...
        <article className="container" itemProp="articleBody">
          ...
          <section className="tldr" aria-label="TL;DR">
            ...
            <ul>
              ...
              <li>
                <strong>Cloud skaliert &amp; beschleunigt</strong> – aber nur
                mit Governance/FinOps.
              </li>
              <li>
          ...
          <section id="definition">
            ...
            <p>
              ...
              meint den Betrieb im eigenen Rechenzentrum oder im
              Colocation-Rack. <strong>Hybrid</strong> kombiniert beides,{" "}
              <strong>Multi-Cloud</strong> nutzt mehrere Public-Cloud-Anbieter.
            </p>
            <div className="infobox">
              <strong>Abgrenzung:</strong> <em>Private Cloud</em> (z. B.
              OpenStack, VMware) kann on-prem oder extern betrieben werden;{" "}
              <em>Edge</em> ergänzt lokale Rechenknoten für
              Latenz/Konnektivität. Datenresidenz, Latenz &amp; Steuerbarkeit
              sind zentrale Unterscheidungsmerkmale.
            </div>
            <div
            ...
            >
              Diagramm-Platzhalter – Architektur-Optionen: On-Prem · Private
              Cloud · Public Cloud · Hybrid/Edge
            </div>
          </section>
          ...
          <section id="nutzen">
            ...
            <p>
              ...
              Management der Cloud-Kosten als Top-Herausforderung – FinOps
              gewinnt entsprechend an Gewicht.
            </p>

            <blockquote className="quote">
              „Ohne durchgängige Verantwortlichkeiten für Kosten – von
              Architektur bis Betrieb – bleibt Cloud ein offener Scheck.“
            </blockquote>
            ...
            <div className="grid grid-2">
              <div className="infobox">
                ...
                Controls-Mapping &amp; Evidenzen). Für Finanzunternehmen gilt
                seit 17.01.2025 zusätzlich DORA mit strenger
                Drittanbieter-Aufsicht.
              </div>
              <div className="infobox">
                <strong>Resilienz &amp; Kosten von Ausfällen:</strong>{" "}
                Uptime-Daten zeigen: weniger Ausfälle, aber höhere Schäden –
                viele signifikante Vorfälle kosten &gt;$100k.
                Architekturentscheidungen sollten diese Folgekosten modellieren.
              </div>
            </div>
            ...
            <div className="infobox">
              ...
              On-Prem). Hyperscaler stellen Emissions-Dashboards bereit.
              Ergebnis hängt von Architektur &amp; Region ab.
            </div>
          </section>
          ...
          <section id="frameworks">
            ...
            <p className="small">
              *Durch geschickte Architektur (Container, offene Schnittstellen)
              und Verträge (Portabilität, Exit) reduzierbar.
            </p>

            <h3>Compliance-Lens für die EU</h3>
            <p>
              Für <strong>NIS2</strong>-relevante Organisationen empfiehlt sich
              ein Controls-Mapping je Workload (z. B. Identitäts-/
              Zugriffsmanagement, Protokollierung, Incident-Reporting,
              Lieferantensteuerung). Finanzinstitute adressieren mit{" "}
              <strong>DORA</strong> zusätzlich Drittanbieter-Risiken (kritische
              ICT-Provider, TLPT, Register).
            </p>

            <div className="infobox">
              <strong>Deutschland-Spezifika (BSI/C5):</strong> Das{" "}
              <em>BSI-C5</em> definiert einen anerkannten Mindeststandard für
              Cloudsicherheit; viele Hyperscaler verfügen über C5-Atteste.
              Prüfe Berichtszeitraum, Scope und Feststellungen in der
              Due-Diligence.
            </div>
            ...
            <div className="placeholder" aria-label="Diagramm: TCO & Risiko">
              ...
              Lizenzen, Betrieb) + Risiko-Bausteine (Ausfall, Compliance,
              Lock-in)
            </div>
          ...
          <section id="howto">
            ...
            <div id="template" className="infobox">
              ...
              <a href="#download-template">
                Workload-Entscheidungsmatrix (Excel/CSV)
              </a>{" "}
              mit Kriterien, Gewichtung &amp; Score-Berechnung. Enthält
              Beispiel-Policies (Tagging, Egress-Budgets) und eine Checkliste
              für NIS2/DORA-Evidenzen.
            </div>
          </section>
            ...
            <div className="grid grid-2">
              ...
              <div>
                ...
                <p>
                  ...
                  <em>&lt;10&nbsp;ms</em> Latenz. Lösung:{" "}
                  <strong>On-Prem/Edge</strong> für Steuerung,{" "}
                  <strong>Cloud</strong> für Training/Analytics. Daten werden
                  lokal gepuffert und zyklisch in ein Data Lakehouse
                  synchronisiert.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Vergabe fordert oft <strong>BSI-C5</strong>-Atteste. Prüfung
                  der Anbieter-Reports (Scope, Zeitraum, Abdeckung) gehört in
                  die Due-Diligence; Datenresidenz &amp; Mandantenfähigkeit
                  sind entscheidend.
                </p>
              </div>
              ...
              <div>
                <h3>KI/ML</h3>
                <p>
                  Training kurzzeitig sehr rechenintensiv →{" "}
                  <strong>Cloud</strong> punktet mit elastischen GPUs;
                  Dauer-Inferencing mit stabiler Last kann{" "}
                  <strong>On-Prem</strong> günstiger sein. Nachhaltigkeit
                  berücksichtigen (Region/CFD, Emissionstools).
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="tools">
            ...
            <ul>
              ...
              <li>
                Compliance Leitplanken: ENISA NIS2 Technical Guidance;
                DORA-Infos (EIOPA).
              </li>
              <li>
                Nachhaltigkeit: Google Cloud Carbon Footprint; Effizienzstudien.
              </li>
          ...
          <section id="risks">
            ...
            <ul>
              <li>
                ...
                explodieren Cloud-Kosten.{" "}
                <span className="warn">Gegenmaßnahme:</span> Tagging-Policy &amp;
                FinOps-RACI.
              </li>
              <li>
                <strong>Egress-Überraschungen:</strong> Datenabflüsse und
                interregionale Transfers werden unterschätzt.{" "}
                <span className="warn">Gegenmaßnahme:</span> Architektur für
                Low-Egress &amp; Datenlokalisierung.
              </li>
              <li>
                <strong>Unterschätzte Ausfallfolgen:</strong> Reine
                Verfügbarkeits-SLAs reichen nicht.{" "}
                <span className="warn">Gegenmaßnahme:</span> Resilienz-Tests,
                Notfallübungen.
              </li>
            </ul>
          ...
          <section id="kontakt" className="cta-panel">
            ...
            <form action="/api/contact" method="post" className="grid grid-2">
              ...
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                <textarea
                  ...
                  name="msg"
                  rows={4}
                  placeholder="Kurze Beschreibung, Ziele, gewünschter Zeitraum ..."
                />
              </div>
              <div style={{ gridColumn: "1 / -1" }}>
            ...
            <p className="small">
              Frühstarter-Bonus: Kostenfreie 45-Min-Sprechstunde für die erste
              10 Workload-Kandidatenanalyse.
            </p>
          </section>
            ...
            <ol className="footnotes">
              <li>
                <a
                  ...
                  rel="noopener"
                >
                  Gartner-Prognose: Public Cloud End-User Spending 2025
                  (~$723&nbsp;Mrd.)
                </a>{" "}
                (CIO Dive, 11/2024).
              </li>
              ...
              <li>
                <a
                  ...
                  rel="noopener"
                >
                  EIOPA: DORA – Entry into application (17.01.2025)
                </a>
                .
              </li>
              <li>
                <a
                  className="ref"
                  href="https://www.datacenterdynamics.com/en/news/uptime-institute-outages-in-2024-less-frequent-and-severe-but-more-expensive/"
                  target="_blank"
                  rel="noopener"
                >
                  Uptime Institute: Ausfälle seltener, aber teurer
                </a>{" "}
                (05/2025).
              </li>
              <li>
                <a
                  className="ref"
                  href="https://www.scitepress.org/Papers/2024/133121/133121.pdf"
                  target="_blank"
                  rel="noopener"
                >
                  Sohani/Agrawal: Cloud-CO₂-Tools
                </a>{" "}
                (2024/2025).
              </li>
              <li>
                <a
                  className="ref"
                  href="https://cloud.google.com/carbon-footprint"
                  target="_blank"
                  rel="noopener"
                >
              ...
              <li>
                ...
                <a
                  className="ref"
                  href="https://www.bsi.bund.de/SharedDocs/Downloads/EN/BSI/Publications/CloudComputing/ComplianceControlsCatalogue-Cloud_Computing-C5.pdf"
                  target="_blank"
                  rel="noopener"
                >
                  C5-Katalog (PDF)
          ...
          <section aria-label="Autor: Expertise">
            <div className="author-card">
              ...
              <div>
                ...
                <br />
                Dr. Alex Neumann ist Cloud-Architekt &amp; FinOps-Practitioner
                mit 12+ Jahren Erfahrung in hybriden Plattformen,
                Kostensteuerung und regulierten Umgebungen. Er begleitet
                Unternehmen von der Strategie über das Architekturdesign bis zur
                Umsetzung mit messbaren Geschäftsergebnissen.
                <div className="small">Reviewed by: Marco Weber, CISO (08/2025)</div>
                <div className="tags">
                  Themen: <a href="/guides/cloud-strategy">Cloud-Strategie</a>,{" "}
                  <a href="/guides/finops">FinOps</a>,{" "}
          ...
          <section
            ...
            className="infobox"
            aria-label="Download Workload-Entscheidungsmatrix"
          >
            <h2>Workload-Entscheidungsmatrix (CSV)</h2>
            <p>
              Lade die Vorlage herunter und passe Kriterien/Gewichtungen an
